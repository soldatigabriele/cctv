...
def yolo(image_path, max_threshold=0.3,  max_confidence=0.5, yolo_location="yolo-coco"):
    # load the COCO class labels our YOLO model was trained on
    labelsPath = os.path.sep.join([yolo_location, "coco.names"])
    ...
    weightsPath = os.path.sep.join([yolo_location, "yolov3.weights"])
